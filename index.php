...
$faq = [
    ...
    [
        ...
        [
            ...
            Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre aIslanda, Liechtenstein e Norvegia) o in Svizzera.
...
<body>
    ...
    <main>
        ...
        <p>
            <?php foreach ($elem['risposta'] as $risposta) { ?>
        <div class="ris">
            <?php echo $risposta ?>
        </div>
        <?php } ?>
